...
#define H_IOB_CACHE_IOB_CSRS_CSRS_H

/** @file iob_cache_iob_csrs.h
 *  @brief Function prototypes for the iob_cache_iob core.
 *
 *  This file contains the function prototypes to access the Control and Status
 * Registers (CSRs) for the iob_cache_iob core.
 *
 ...
 */
void iob_cache_iob_csrs_init_baseaddr(uint32_t addr);
